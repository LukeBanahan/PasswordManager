...
class PasswordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create password" do
    assert_difference("Password.count") do
      post passwords_url, params: { password: { password: @password.password, username: @password.username, website: @password.website } }
    end
  ...
  test "should update password" do
    patch password_url(@password), params: { password: { password: @password.password, username: @password.username, website: @password.website } }
